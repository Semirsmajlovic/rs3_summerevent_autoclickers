...
CLICK_INTERVAL_MIN = 80  # Minimum interval between clicks (seconds)
CLICK_INTERVAL_MAX = 85  # Maximum interval between clicks (seconds)
...
def click_loop():
    ...
    try:
        ...
        while running:
            ...
            click_count += 1
            logging.info(f"Clicked to Enter Dungeoneering Hole. Total clicks: {click_count}")
